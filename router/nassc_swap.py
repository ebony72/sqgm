...
class NASSCSwap(TransformationPass):
    ...
    def __init__(
            ...
            seed=None,
            fake_run=False,
            enable_factor_block=False,
            enable_factor_commute_0=False,
            enable_factor_commute_1=False,
            factor_block=0,
            factor_commute_0=0,
            factor_commute_1=0,
            decomposer2q=None,
        ...
        while front_layer:
            ...
            for swap_qubits in swap_scores:
                ...
                if len(predecessor_block)>0:
                    if predecessor_block[-1].name != "swap":
    ...
    def _apply_gate_consider_commutation(self,swap_commutation, mapped_dag, node, current_layout, canonical_register):
        ...
        if swap_commutation:
            ...
            if swap_commutation[4]:
                new_node = mapped_dag.apply_operation_back(new_node.op, [new_node.qargs[1],new_node.qargs[0]], new_node.cargs)
