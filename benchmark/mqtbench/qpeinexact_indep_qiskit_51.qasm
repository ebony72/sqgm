...
h q[49];
x psi[0];
cp(0.20473336) psi[0],q[0];
cp(0.40946672) psi[0],q[1];
cp(0.81893345) psi[0],q[2];
cp(1.6378669) psi[0],q[3];
cp(-3.0074515) psi[0],q[4];
cp(0.26828227) psi[0],q[5];
cp(0.53656455) psi[0],q[6];
cp(1.0731291) psi[0],q[7];
cp(2.1462582) psi[0],q[8];
cp(-1.9906689) psi[0],q[9];
cp(2.3018474) psi[0],q[10];
cp(-1.6794905) psi[0],q[11];
cp(2.9242044) psi[0],q[12];
cp(-0.43477653) psi[0],q[13];
cp(-0.86955307) psi[0],q[14];
cp(-1.7391061) psi[0],q[15];
cp(2.804973) psi[0],q[16];
cp(-0.67323922) psi[0],q[17];
cp(-1.3464784) psi[0],q[18];
cp(-2.6929569) psi[0],q[19];
cp(0.89727152) psi[0],q[20];
cp(1.794543) psi[0],q[21];
cp(-2.6940992) psi[0],q[22];
cp(0.89498685) psi[0],q[23];
cp(1.7899737) psi[0],q[24];
cp(-2.7032379) psi[0],q[25];
cp(0.87670953) psi[0],q[26];
cp(1.7534191) psi[0],q[27];
cp(-2.7763472) psi[0],q[28];
cp(0.73049094) psi[0],q[29];
cp(1.4609819) psi[0],q[30];
cp(2.9219638) psi[0],q[31];
cp(-0.4392578) psi[0],q[32];
cp(-0.87851559) psi[0],q[33];
cp(-1.7570312) psi[0],q[34];
cp(2.7691229) psi[0],q[35];
cp(-0.74493942) psi[0],q[36];
cp(-1.4898788) psi[0],q[37];
cp(-2.9797577) psi[0],q[38];
cp(0.32366995) psi[0],q[39];
cp(0.64733989) psi[0],q[40];
cp(1.2946798) psi[0],q[41];
cp(2.5893596) psi[0],q[42];
cp(-1.1044662) psi[0],q[43];
cp(-2.2089323) psi[0],q[44];
cp(1.8653206) psi[0],q[45];
cp(-13*pi/16) psi[0],q[46];
cp(3*pi/8) psi[0],q[47];
cp(3*pi/4) psi[0],q[48];
cp(-pi/2) psi[0],q[49];
swap q[0],q[49];
h q[0];
swap q[1],q[48];
